...
/**
 * 物品弹药治疗炮台：优先瞄准范围内受伤的友方单位/建筑；没有受伤友方时，会正常攻击敌人。
 *
 * 继承 ItemTurret，通过物品作为弹药。
 */
public class HealingItemTurret extends ItemTurret {

  public HealingItemTurret(String name) {
    super(name);
  ...
  public class HealingItemTurretBuild extends ItemTurretBuild {

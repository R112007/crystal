...
public class AddWeaponFieldAbility extends Ability {
  ...
  public AddWeaponFieldAbility(Weapon weapon, float duration, float range, float reload, int amount) {
    this.weapon = weapon;
  ...
  public AddWeaponFieldAbility(Weapon weapon, float duration, float range, float reload) {
    this.weapon = weapon;
    this.duration = duration;
    this.range = range;
    this.reload = reload;

...
public class SclRegionEffect extends Effect {
  ...
  public void render(EffectContainer e) {
    if (tex == null)
      Vars.ui.showErrorMessage("SclRegionEffect's tex is null");
    ...
    float ox = e.x + Angles.trnsx(realRotation, offsetX * flip, offsetY),
        oy = e.y + Angles.trnsy(realRotation, offsetX * flip, offsetY);
